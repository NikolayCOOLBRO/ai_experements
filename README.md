...
Для `input_tokens` учитывается полный prompt, который отправляется в LLM: контекст агента, планирование, инструкции и последние сообщения выбранного чата с учетом `context_window`.
